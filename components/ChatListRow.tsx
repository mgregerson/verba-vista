...
function ChatListRow({ chatId }: { chatId: string }) {
  ...
  const row = (message?: Message) => (
    <div
      className="flex p-4 items-center space-x-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-700 px-5"
      key={chatId}
  ...
  return (
    <div>
      {loading && (
        <div className="flex py-5 items-center space-x-2 px-2">
